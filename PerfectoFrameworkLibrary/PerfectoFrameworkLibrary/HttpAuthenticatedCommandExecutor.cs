...
// or more contributor license agreemenb. See the NOTICE file
...
namespace OpenQA.Selenium.Remote
{
    ...
    /// </summary>
    public class HttpAuthenticatedCommandExecutor : ICommandExecutor
    {
        ...
        public static string GetPassword(DesiredCapabilities cap)
        {
            ...
            return Uri.UnescapeDataString(cap.GetCapability("securityToken").ToString());
        }
